...
const taskMode = $('.add-mode')
const taskPlay = $('.add-play')
const taskList = []


//setup firebase
const firebaseConfig = {
    apiKey: "AIzaSyCV1gtoi3kppj7BueFns4WlkqNdx8QU--A",
    authDomain: "todo-list-726ea.firebaseapp.com",
    databaseURL: "https://todo-list-726ea-default-rtdb.firebaseio.com",
    projectId: "todo-list-726ea",
    storageBucket: "todo-list-726ea.appspot.com",
    messagingSenderId: "325012348485",
    appId: "1:325012348485:web:2b5fd466f4ef68d40fcd2c",
    measurementId: "G-VDM258E6DV"
  };
...
const App = {
        ...
        function time() {
            ...
            const comingTaskList = taskList.filter((task) => {
                ...
                if ((taskTime-realTime) === 0) {
                    console.log(task);
                    _this.firebase(task.mode, task.desc, task.play, task.hour, task.minute)
                }
    ...
    firebase(mode, desc, play, hour, minute) { 
        if (isNaN(play)) {
            play = 0; // Giá trị mặc định nếu không phải là số
        }
    ...
    addTask() {
        ...
        newTask.mode = taskMode.value
        newTask.play = taskPlay.value
